...
const Dashboard = () => {
  ...
  const COLORS = ["#1D4ED8", "#16A34A", "#D97706"];
    ...
    <div className="p-6 bg-white min-h-screen text-gray-900">
      ...
      <div className="mb-12">
        <div className="bg-white rounded-lg shadow-lg p-6 border border-gray-300">
          ...
          {salesData.length === 0 ? (
            <p className="text-center text-gray-400 mt-4">No sales data for selected range</p>
          ) : (
            <div className="h-80">
      ...
      <div className="mb-12">
        <div className="bg-white rounded-lg shadow-lg p-6 border border-gray-300">
          ...
          {paymentData.length === 0 ? (
            <p className="text-center text-gray-400 mt-4">No payment data</p>
          ) : (
            <div className="h-80">
              <ResponsiveContainer width="100%" height="100%">
                <PieChart>
