...
const Profile = () => {
  ...
  return (
    <div className="h-[600px] bg-gradient-to-br from-[#eef2f3] to-[#f7f9fb] flex items-center justify-center p-4">
      <ToastContainer position="top-right" autoClose={3000} />
      <div className="relative bg-gray-100 p-10 rounded-3xl shadow-2xl w-full max-w-4xl transition-all">
        <button
